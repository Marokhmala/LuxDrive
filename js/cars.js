...
function getFilters() {
  ...
  const transmissions = [...document.querySelectorAll(".filter-transmission:checked")]
    .map(el => el.value);
...
function applyFilters() {
  const { search, maxPrice, brands, transmissions, minCapacity, city, sort } = getFilters();
